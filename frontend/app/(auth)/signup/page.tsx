  ...
  return (
    <main className="relative h-dvh w-full overflow-hidden bg-[#F7F4FF]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* Decorative dots */}
        <div className="absolute left-[5%] top-[20%] h-2 w-2 rounded-full bg-[#7A5AF8]/30 shadow-[0_0_20px_5px_rgba(122,90,248,0.2)]" />

        <div className="absolute right-[8%] top-[25%] h-1.5 w-1.5 rounded-full bg-[#9B7CFF]/40 shadow-[0_0_18px_4px_rgba(155,124,255,0.25)]" />

        <div className="absolute bottom-[17%] left-[46%] h-1.5 w-1.5 rounded-full bg-[#7A5AF8]/30" />
      </div>
        ...
        >
          ...
          >
            ...
            <p
              ...
              "
            >
              Create your account and automatically review code, detect
              vulnerabilities, and ship better software with confidence.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="p-5 font-mono text-[10px] leading-[1.9]">
                <div>
                  <span className="text-[#7A5AF8]">const</span>{" "}
                  <span className="text-[#5B6172]">project</span>{" "}
                ...
                <div className="pl-4">
                  ...
                  <span className="text-[#7A5AF8]">
                    create
                  </span>

                  <span className="text-[#18181B]/25">
                    (
                  </span>
                </div>
                ...
                <div className="pl-4 text-[#18181B]/30">
                  );
                </div>
                ...
                <div className="mt-1 pl-4 text-emerald-600/80">
                  ✓ AI review enabled
                </div>
              </div>
            ...
            <motion.div
              ...
              className="
                ...
                bg-white/75
                text-[#7A5AF8]
                shadow-[0_12px_30px_-12px_rgba(122,90,248,0.4)]
                backdrop-blur-xl
              "
            >
          ...
          >
            <span className="text-[10px] text-[#5B6172]/55">
              Join developers building better software
            </span>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <p className="mt-1 text-[12px] text-[#5B6172]">
                      Start reviewing code with enterprise-grade AI.
                    </p>
                  </motion.div>
                          ...
                          >
                            <div className="mt-2.5">
                              <div className="flex items-center justify-between">
                                <span className="text-[9px] font-medium text-[#5B6172]">
                                  Password strength
                                </span>
                              ...
                              <div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-[#7A5AF8]/10">
                                <motion.div
                  ...
                  <div className="my-4 flex items-center gap-3">
                    ...
                    <span className="text-[7px] font-medium uppercase tracking-[0.15em] text-[#5B6172]/40">
                      Secure access
                    </span>
                  ...
                  <div className="flex items-center justify-center gap-2 text-[8px] text-[#5B6172]/60">
                    <IconCircleCheck className="h-3.5 w-3.5 text-emerald-500/70" />

                    <span>Encrypted authentication</span>

                    <span className="text-[#7A5AF8]/20">
                      •
                    </span>
